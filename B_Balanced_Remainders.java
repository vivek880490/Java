...
public class B_Balanced_Remainders
{
	...
	public static void main (String[] args) throws java.lang.Exception
	{
	    ...
	    while(t-->0)
	    {
            ...
            //int ans=0;
        //     int a=Math.max(c0,Math.max(c1,c2));
        //     int b=Math.min(c0,Math.min(c1,c2));
        //    System.out.println(c0+" "+c1+" "+c2);
        //    int ans=Math.max(Math.abs(c0-c2),Math.abs(c1-c2));
        //     System.out.println(ans);
            System.out.println(Math.max((c0-c2), Math.max((c2-c1), (c1-c0))));
            // for(int i=0;i<2;i++){
            //     if(c0>b){
            //         ans=ans+c0-b;
            //         c1=c1+c0-b;
