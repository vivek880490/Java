...
public class gfg
{
	...
	public static void main (String[] args) throws java.lang.Exception
	{
        ...
        //    reversefromto(arr, 0, d-1);
        //    reversefromto(arr,d,n-1);
        //    reversefromto(arr,0,n-1);
        ...
        while(t-->0){
            ...
            public static void absjbdb(int []a,int i,int j){ 
                int l=i;
                int r=j;
                while(l<r){ 
                    int temp=a[l]; 
    ...
    public static void reversefromto(int []a,int i,int j){ 
        int l=i;
        int r=j;
        while(l<r){ 
            int temp=a[l]; 
